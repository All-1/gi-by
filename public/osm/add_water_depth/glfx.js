...
var fx = function() {
    ...
    (function() {
        function a(b) {
            ...
            b.framebufferTexture2D(b.FRAMEBUFFER, b.COLOR_ATTACHMENT0, b.TEXTURE_2D,
                e, 0);
            c = b.createTexture();
    ...
    var r = function() {
        ...
        b.prototype.toImage = function(b) {
            ...
            for (var m = 0; m < g; m++) p.data[m] = f[m];
    ...
    var h = function() {
            function b(b, c) {
                ...
                a.shaderSource(d, c);
                a.compileShader(d);
                if (!a.getShaderParameter(d, a.COMPILE_STATUS)) throw "compile error: " +
                    ...
                    if (b.hasOwnProperty(c)) {
                        ...
                        if (null !== d) {
                            ...
                            if ("[object Array]" == Object.prototype.toString.call(e)) switch (e.length) {
                                ...
                                } else if ("[object Number]" == Object.prototype.toString.call(e)) a.uniform1f(d, e);
                                else throw 'attempted to set uniform "' + c + '" to invalid value ' + (e || "undefined").toString();
                        }
                    } return this
            };

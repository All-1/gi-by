...
foreach($result as $row){
	...
	<a href='$image' target='_blank'>
		...
		<div style='margin-top:8px; margin-left:8px; font-size:18px; line-height:1.3; width:calc(100% - 48px); margin-right:8px; display:inline-block; vertical-align:top;'>$name</div>
